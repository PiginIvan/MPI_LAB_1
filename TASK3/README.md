...
- `MPI_Scatter` / `MPI_Gather` — распределение и сбор подматриц.  
...
![Speedup S vs P](speedup_vs_P_per_N.png)
...
![Speedup S vs N](speedup_vs_N_per_P.png)
При фиксированном числе процессов **P**, с увеличением размера матрицы **N**, ускорение растёт.  
Это связано с тем, что при больших **N** доля вычислений становится выше по сравнению с затратами на обмен данными.  
Иными словами, эффективность параллельной работы лучше проявляется при больших задачах.

**Идеально:** линии идут вверх с ростом **N**.

---

### 4. Эффективность (E vs P)
