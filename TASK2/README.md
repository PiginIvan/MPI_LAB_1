...
**Ключевые наблюдения:**
- **Построчная схема** занимает промежуточное положение
- **Поколоночная схема** демонстрирует наихудшее время выполнения из-за необходимости суммирования частичных результатов
- **Блочная схема** показывает наилучшие результаты для большинства конфигураций
...
**Основные выводы:**
- **Построчная схема** сохраняет высокую эффективность для больших матриц даже при 8 процессах
...
1. **Построчная схема** является наиболее эффективной для данной задачи, демонстрируя лучшее ускорение и эффективность
